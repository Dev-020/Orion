...
REPLAY_SAVE_PATH = "C:/GitBash/Orion/misc_scripts/replay/video_replays"
...
def shutdown_obs():
    ...
    """
    global obs_client, obs_process, file_observer
...
def start_replay_watcher(path, callback_func):
    ...
    if not os.path.exists(path):
        print(f"[ERROR] Replay path not found: {path}")
        print("Please create this directory or correct REPLAY_SAVE_PATH.")
        return False
